            ...
            <div class="card-body">
                <form id="formulario">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center text-capitalize p-2">
                            <label for=""><?php echo $row->permiso; ?></label><br>
                                ...
                                <input type="checkbox" name="permisos[]" value="<?php echo $row->id; ?>" <?php echo isset($asignados[$row->id]) ? 'checked' : ''; ?>>
                        </div>
                        <?php } ?>
                    ...
                    <div class="d-grid gap-2">
                        <button class="btn btn-outline-primary" type="button" onclick="registrarPermisos(event);"><i
                                class="fa fa-registered" aria-hidden="true"></i>Asignar permisos</button>
