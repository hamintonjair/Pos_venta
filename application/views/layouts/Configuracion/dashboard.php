        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-primary">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    ...
                    <span class="text-white"><?php echo $usuarios[0]->total ?></span>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card bg-success">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    ...
                    <span class="text-white"><?php echo $clientes[0]->total ?></span>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card bg-danger">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    ...
                    <span class="text-white"><?php echo $proveedores[0]->total ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-warning">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    ...
                    <span class="text-white"><?php echo $ventas[0]->total ?></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div style="background-color: #888888;">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    ...
                    <span class="text-white"><?php echo $entrada[0]->total ?></span>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div style="background-color: #FF69B4;">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    ...
                    <span class="text-white"><?php echo $salidas[0]->total ?></span>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div style="background-color: #800080;">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    ...
                    <span class="text-white"><?php echo $productos[0]->total ?></span>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div style="background-color: #87CEEB;">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a href="<?php echo base_url(); ?>Ventas/historialVenta" class="text-white">Ver Detalle</a>
                    <span class="text-white"><?php echo $categorias[0]->total ?></span>
                </div>
            </div>
        </div>
    </div>
