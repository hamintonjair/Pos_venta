...
<html lang="en">
  ...
  <title>Punto de vanta</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url; ?>Assets/Admin/js/datepicker/jquery-ui.min.css">


    <!-- <link rel="stylesheet" type="text/css" href="<?php echo base_url; ?>Assets/Admin/css/select2.min.css">  -->
    <!-- Font-icon css-->
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo base_url; ?>Assets/Admin/css/style.css"> 
    <link rel="stylesheet" type="text/css" href="<?php echo base_url; ?>Assets/Admin/css/style2.css">  -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url; ?>Assets/Admin/css/stylereal.css"> 
    <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo base_url; ?>Assets/Admin/css/toastr.css">  -->
